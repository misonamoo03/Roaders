...
<body>
	...
	<main class="main">
		<section class="main-container">
			...
			<form action="">
			<div class="sub-main">
			* 장소명		<input type="text" name="locationName" id="locationName"><br>
			* 담당자*		<input type="text" name="charher" id ="charher"><br>
			* 연락처*		<input type="text" name="locationCellphone" id="locationCellphone"><br>
			* 전화번호*	<input type="text" name="locationPhone" id="locationPhone"><br>
			* 배송우편번호	<input type="text" name="locationPost" id="locationPost" class="zip required">
			<button class="address-search-button">주소찾기</button><br>
			* 주소		<input type="text"  name="locationAddress1" id="locationAddress1" class="address-basic required" ><br>
			* 상세주소		<input type="text" name="locationAddress2" id="locationAddress2" class="address-detail"><br>
			<input type="checkbox" name="defaultLocationChk" id="defaultLocationChk"  value="Y">기본장소여부<br>
			
			<input type="submit" formaction="insertLocation" formmethod="post" name="locationInsertBtn" id="locationInsertBtn" value="등록"> 
			</div>
		</section>
		</form>
	</main>
