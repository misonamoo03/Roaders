   ...
   <div v-bind:style="detailContainer">
         ...
         <div>
            ...
            <div v-bind:style="buttonWrap">
               <span v-if="item.deliveryState == '1'">
                  <button @click="requestDelivery" type="button">배송지원</button>
               </span>
      ...
      <div v-bind:style="popup" v-show="requestDelivery_show" style="z-index: 999;">
         <form v-on:submit="requestDelivery">
            ...
            <button @click="requestDelivery">배송지원 </button>

         </form>
         <button @click="requestPop" type="button">닫기 </button>               
      </div>

      <div v-bind:style="popup" v-show="registPickup_show">
      ...
      <div v-bind:style="popup" v-show="completeDelHistory_show">
      ...
      <div v-bind:style="popup" v-show="reviewDelivery_show">
